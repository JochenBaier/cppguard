...
{
public:
  deadlock_monitor_t(runtime_options_t& p_runtime_options);
  ...
  void dlc_deadlock_check_before_lock(void* mu, void** p_hold_locks, uint64_t& p_graphid_handle);
  ...
  void cppguard_cnd_wait(const void* mu);
