...
#include "test_in_cpp_file_shared_lib.hpp"
...
#ifdef __linux__
#include "../cppguard/include/cppguard.hpp"
#include "../tests/critical_section_linux.hpp"
#endif

void test_cpp_file_in_shared_lib_thread_sanitzer_example()
{
